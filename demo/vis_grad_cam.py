...
from mmdet.utils.det_grad_cam_visualizer import (DetBoxScoreTarget, DetCAMModel,
                                                 DetCAMVisualizer,
                                                 reshape_transform)
...
def main():
    ...
    for image_path in images:
        ...
        model.set_return_loss_and_model(True)
        model.set_input_data(image, bboxes=bboxes, labels=labels)

        det_cam_visualizer = init_cam(args, model)
